...
echo "Creating Encrypted OTA Client binaries..."
...
$JET -m bin -f Client.bin -e Client_Enc.bin -k 0xffffffffffffffffffffffffffffffff -i 0x00000000000000000000000000000000 -v $5 -j $4
...
$JET -m bin -f UpGradeImagewithOTAHeaderV2.bin -e UpGradeImagewithOTAHeaderV2_Enc.bin -v $5 -k ffffffffffffffffffffffffffffffff -i 0x00000000000000000000000000000000 -j $4

# Wrap the Image with OTA header with version 2
$JET -m otamerge --ota -c UpGradeImagewithOTAHeaderV2_Enc.bin -o Client_UpgradeImagewithOTAHeaderV2_Enc.bin -v $5 -n 2 -u $3 -t $7 -j $4
$JET -m otamerge --ota -c UpGradeImagewithOTAHeaderV2_Enc.bin -o Client_UpgradeImagewithOTAHeaderV2_Enc.ota -p 1 -v $5 -n 2 -u $3 -t $7 -j $4
...
$JET -m bin -f UpGradeImagewithOTAHeaderV3.bin -e UpGradeImagewithOTAHeaderV3_Enc.bin -v $5 -k ffffffffffffffffffffffffffffffff -i 0x00000000000000000000000000000000 -j $4

# Wrap the Image with OTA header with version 3
$JET -m otamerge --ota -c UpGradeImagewithOTAHeaderV3_Enc.bin -o Client_UpgradeImagewithOTAHeaderV3_Enc.bin -v $5 -n 3 -u $3 -t $7 -j $4
$JET -m otamerge --ota -c UpGradeImagewithOTAHeaderV3_Enc.bin -o Client_UpgradeImagewithOTAHeaderV3_Enc.ota -p 1 -v $5 -n 3 -u $3 -t $7 -j $4
